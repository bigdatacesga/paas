...
http POST http://paas:6000/bigdata/api/v1/products name=mongodb version=3.2.8 description='MongoDB is a free and open-source cross-platform document-oriented database.' x-auth-token:$TOKEN
